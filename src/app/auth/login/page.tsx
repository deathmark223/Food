...
function LoginForm() {
  ...
  const [loginMethod, setLoginMethod] = useState<'google' | 'sms' | 'email'>('google')
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      setErrors({ general: t('errors.google_not_implemented', 'Google login will be available soon') })
    } catch (error: any) {
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {t('auth.login_google', 'Continue with Google')}
            </button>
          ...
          <div className="text-center">
            <p className="text-gray-600">
              ...
              <Link href={`/auth/register?role=${role}`} className="text-primary-600 hover:text-primary-500 font-medium">
